...
export const siteConfig: SiteConfig = {
	title: "Fatetech",
	subtitle: "命运科技",
	siteURL: "https://blog.196482.xyz/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-04-05", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "3494368029706875", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "Fatetech命运科技", // 主页横幅主标题

			subtitle: [
				"没什么特别的，有你在就足够了",
				"现在你仍是我的光芒",
				"你呀，不知不觉中已经成了我每天的一部分了呀",
				"和你聊天的话，感觉每天都会有点开心呢",
				"今天是平平淡淡的一天，但是，也是有点好的日子",
			],
			typewriter: {
	...
	thirdPartyAnalytics: {
		...
		clarityId: "w6ugfdfn2s", // Clarity 项目 ID
	},
};
...
export const profileConfig: ProfileConfig = {
	avatar: "https://pic.fatetech.cc.cd/file/1775700308888_avatar.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Fate命定指冠",
	bio: "世界很大，我想去看看",
	typewriter: {
...
export const permalinkConfig: PermalinkConfig = {
	enable: ture, // 是否启用全局 permalink 功能，关闭时使用默认的文件名作为链接
	/**
	 * permalink 格式模板
	 * 支持的占位符：
	 * - %year% : 4位年份 (2024)
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo.fatee.dpdns.org",
		lang: SITE_LANG,
	},
	giscus: {
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到这里，希望你能找到自己的一番天地", // 公告内容
